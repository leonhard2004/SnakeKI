...
def wand_layer(richt_x, richt_y, score, tempo, snake, bonus_x, bonus_y, GRÖßE, BREITE, HÖHE):
 ...
 l_1 = kopf_y / GRÖßE
 l_2 = (BREITE - kopf_x) / GRÖßE
 l_3 = (HÖHE - kopf_y) / GRÖßE
 l_4 = kopf_x / GRÖßE
 l_5 = diagonaler_abstand(l_1, l_2)
 l_6 = diagonaler_abstand(l_2, l_3)
 l_7 = diagonaler_abstand(l_3, l_4)
 l_8 = diagonaler_abstand(l_4, l_1)
 ki_steuerung = snake_body(richt_x, richt_y, score, tempo, snake, bonus_x, bonus_y, GRÖßE, BREITE, HÖHE,  l_1, l_2, l_3, l_4, l_5, l_6, l_7, l_8)
 return ki_steuerung

def snake_body(richt_x, richt_y, score, tempo, snake, bonus_x, bonus_y, GRÖßE, BREITE, HÖHE, l_1, l_2, l_3, l_4, l_5, l_6, l_7, l_8):
 ...
 ki_steuerung = food(kopf_x, kopf_y, richt_x, richt_y, score, tempo, snake, bonus_x, bonus_y, GRÖßE, BREITE, HÖHE, l_1, l_2, l_3, l_4, l_5, l_6, l_7, l_8, l_9, l_10, l_12, l_13, l_14, l_15, l_16)
 return ki_steuerung

def food(kopf_x, kopf_y, richt_x, richt_y, score, tempo, snake, bonus_x, bonus_y, GRÖßE, BREITE, HÖHE, l_1, l_2, l_3, l_4, l_5, l_6, l_7, l_8, l_9, l_10, l_12, l_13, l_14, l_15, l_16):
 l_17 = layer_apple(bonus_x, bonus_y, kopf_x, kopf_y, GRÖßE)
 l_18 = layer_apple(bonus_y, kopf_x, kopf_y, bonus_x, GRÖßE)
 l_19 = layer_apple(bonus_x, kopf_y, kopf_x, bonus_y, GRÖßE)
 l_20 = layer_apple(bonus_y, bonus_x, kopf_y, kopf_x, GRÖßE)
